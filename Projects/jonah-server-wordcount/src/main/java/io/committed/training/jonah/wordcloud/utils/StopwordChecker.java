package io.committed.training.jonah.wordcloud.utils;
...
public class StopwordChecker {
  private static final Set<String> STOP_WORDS = new HashSet<>(Arrays.asList(new String[] {"a", "as",
      "able", "about", "above", "according", "accordingly", "across", "actually", "after",
      "afterwards", "again", "against", "aint", "all", "allow", "allows", "almost", "alone",
      ...
      "apart", "appear", "appreciate", "appropriate", "are", "arent", "around", "as", "aside",
      ...
      "brief", "but", "by", "cmon", "cs", "came", "can", "cant", "cannot", "cant", "cause",
      ...
      "given", "gives", "go", "goes", "going", "gone", "got", "gotten", "greetings", "had", "hadnt",
      "happens", "hardly", "has", "hasnt", "have", "havent", "having", "he", "hes", "hello", "help",
      "hence", "her", "here", "heres", "hereafter", "hereby", "herein", "hereupon", "hers",
      "herself", "hi", "him", "himself", "his", "hither", "hopefully", "how", "howbeit", "however",
      "i", "id", "ill", "im", "ive", "ie", "if", "ignored", "immediate", "in", "inasmuch", "inc",
